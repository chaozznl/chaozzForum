<?php
	...
	$txt[50] = "Topic moved<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[51] = "Topic not found";
	$txt[52] = "Post not found";
	$txt[53] = "Either the title or the message was empty. Please fix that";
	$txt[54] = "Topic posted<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[55] = "Topic updated<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[56] = "The message was empty. Please fix that";
	$txt[57] = "Reply posted<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[58] = "Reply updated<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[59] = "Topic removed<br /><a href=\"".$url."/viewboard/board_id/".$txt_board_id.".htm\">View the board</a>";
	$txt[60] = "Post removed<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[62] = "Topic locked<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[64] = "Topic unlocked<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[66] = "Topic made sticky<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[68] = "Topic made unsticky<br /><a href=\"".$url."/viewtopic/topic_id/".$txt_topic_id.".htm\">View the topic</a>";
	$txt[69] = "Edit topic";
	$txt[70] = "Edit post";
	$txt[71] = "Title";
	$txt[72] = "Message";
	$txt[73] = "Post";
	$txt[74] = "User removed";
	$txt[75] = "User banned<br /><a href=\"".$url."/profile/user_id/".$txt_user_id.".htm\">Back to user profile</a>";
	$txt[76] = "User unbanned<br /><a href=\"".$url."/profile/user_id/".$txt_user_id.".htm\">Back to user profile</a>";
	$txt[77] = "User added to group<br /><a href=\"".$url."/profile/user_id/".$txt_user_id.".htm\">Back to user profile</a>";
	$txt[78] = "You typed the wrong security code<br /><a href=\"".$url."/profile.htm\">Go back and try again</a>";
	$txt[79] = "Email address already in use<br /><a href=\"".$url."/profile.htm\">Go back and try again</a>";
	$txt[80] = "Username already in use<br /><a href=\"".$url."/profile.htm\">Go back and try again</a>";
	$txt[81] = "Your account was succesfully created<br />You can now <a href=\"".$url."/user.htm\">login</a>";
	$txt[82] = "Profile data updated<br /><a href=\"".$url."/profile/user_id/".$txt_user_id.".htm\">Back to user profile</a>";
	$txt[83] = "User Profile";
	...
	$txt[99] = "replies";
	$txt[100] = "Pages";
	$txt[101] = "Your are now logged out.<br />To continue <a href=\"".$url."\">click here</a>";
	$txt[102] = "Invalid name or password.<br /><a href=\"".$url."/user.htm\">Try again</a>";
	$txt[103] = "You were succesfully logged in!<br />To continue <a href=\"".$url."\">click here</a>";
	$txt[104] = "User login";
	$txt[105] = "Login";
